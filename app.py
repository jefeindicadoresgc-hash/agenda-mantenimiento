...
# ==========================================
st.set_page_config(
    page_title="Portal de Mantenimiento - Grupo Cruces", 
    page_icon="🔧", 
    layout="wide",
    initial_sidebar_state="expanded"
)

# --- BLOQUE DE CSS PARA OCULTAR BARRA DE STREAMLIT Y GITHUB ---
st.markdown("""
    <style>
        /* Ocultar el menú superior (tres puntos) y botones de Share/GitHub */
        header {visibility: hidden;}
        .stAppHeader {display: none;}
        
        /* Ocultar la marca de agua del pie de página 'Made with Streamlit' */
        footer {visibility: hidden;}
        
        /* Ocultar el botón de GitHub 'Fork app' o 'Edit' en la esquina */
        .viewerBadge_container__1QSob {display: none;}
        #MainMenu {visibility: hidden;}
        
        /* Ajustar el margen superior para que no quede un hueco blanco vacío */
        .block-container {
...
st.markdown(f"**Capacidad técnica diaria:** `{MAX_HORAS_DIA} horas máximas por turno` | **Acceso:** `Público para agendar / Restringido para modificar`.")
